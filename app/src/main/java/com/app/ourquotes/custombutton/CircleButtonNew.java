package com.app.ourquotes.custombutton;
...
public class CircleButtonNew extends ImageView
{
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		if (attrs != null) {
			...
			pressedRingWidth = (int) a.getDimension(R.styleable.CircleButton_cb_pressRingWidth, pressedRingWidth);
			a.recycle();
		}
